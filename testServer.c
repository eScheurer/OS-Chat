...
//
// TODO: define struct Task so that we can jsut shuff things around as tasks instead of multiple single infos??
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <time.h>
...
int main() {
    ...
    while (1) {
        ...
        add_task_to_queue(taskTest); //Pass socket to threadpool to handly reading and responding
    }
}
